...
M = {
  ...
  hl_override = {
    ...
    St_NormalModeSep = { fg = "#5E678F", bg = "none" },
    St_InsertMode = { bg = "#8891B8" },
    St_InsertModeSep = { fg = "#8891B8", bg = "none" },
    St_VisualMode = { bg = "#535870" },
    St_VisualModeSep = { fg = "#535870", bg = "none" },
    St_CommandMode = { bg = "#5B648C" },
    St_CommandModeSep = { fg = "#5B648C", bg = "none" },
    St_TerminalMode = { bg = "#666F97" },
    St_TerminalModeSep = { fg = "#666F97", bg = "none" },
    St_NTerminalMode = { bg = "#666F97" },
    St_NTerminalModeSep = { fg = "#666F97", bg = "none" },
